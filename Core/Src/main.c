...
void HAL_SPI_RxCpltCallback(SPI_HandleTypeDef *hspi)
{
	CDC_TransmitWithFifo_FS((uint8_t*)&gData_from_spi, sizeof(gData_from_spi));
	 //HAL_SPI_Receive_IT(&hspi1, (uint8_t*)&gData_from_spi, 4);
	//static int state = 0;
	// we have new data from SPI
//	switch (state)
//	{
//	case 0:
//		gDataAssembly = 0;
...
//		break;
//	case 1:
//		gDataAssembly |= (uint32_t)gData_from_spi;
//		state = 2;
//		break;
//	case 2:
//		gDataAssembly |= (uint32_t)gData_from_spi<<8;
//		state = 3;
//		break;
//	case 3:
//		gDataAssembly |= (uint32_t)gData_from_spi<<16;
//		state = 4;
//		break;
//	case 4:
//		gDataAssembly |= (uint32_t)gData_from_spi<<24;
//		state = 5;
//		break;
//	case 5:
//		if(gData_from_spi == 0xff)
